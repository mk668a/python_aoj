...
public double[]  RAND3(int n){
        double x = 1;
        int next = 0;
        double A[] = this.RAND2(55);
        int M = 2147483647;
        double rand_seq[] = new double[n];
        for(int i=0; i<n; i++) {
                int j = (next + 31) % 55;
...
public double[] histogram(double R[]){
        double M = 2147483647;
