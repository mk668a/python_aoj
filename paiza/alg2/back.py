...
def MAT_MULT(A_, B_):
    ...
    if(n == 1):
        ...
        C[0] = sumMatrix(MAT_MULT(a11, b11), MAT_MULT(a12, b21))[0]
        C[1] = sumMatrix(MAT_MULT(a11, b12), MAT_MULT(a12, b22))[0]
        C[2] = sumMatrix(MAT_MULT(a21, b11), MAT_MULT(a22, b21))[0]
        C[3] = sumMatrix(MAT_MULT(a21, b12), MAT_MULT(a22, b22))[0]
...
def Strassens(A_, B_):
    ...
    if(n == 1):
        ...
        C[0] = deleteMatrix(sumMatrix(P5, P4), sumMatrix(P2, P6))[0]
        C[1] = sumMatrix(P1, P2)[0]
        C[2] = sumMatrix(P3, P4)[0]
        C[3] = deleteMatrix(sumMatrix(P1, P5), deleteMatrix(P3, P7))[0]
...
# 分割
# print(A)
# A = DivideMatrix(A, len(A), len(A)/2)
# print(A)
